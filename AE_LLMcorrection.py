...
def autoencoder_correction_with_comparison(primary,
                                           fallback,
                                           device='cpu',
                                           epochs=50,
                                           lr=1e-3):
    """
    ----
    primary : array-like or Tensor, shape (N, D)
    fallback: array-like or Tensor, shape (N, D)
    device   : 'cpu' or 'cuda'
    ----
    corrected : Tensor, shape (N, D)
    """
